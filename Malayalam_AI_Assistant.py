...
# # llama-server.exe -m D:\Projects\Gemma2_MalayaLLM\unsloth.Q4_K_M.gguf -ngl 42 -c 128 -n 20

# class SpeechRecognitionApp:
#     def __init__(self, root):
#         self.root = root
#         self.root.title("മലയാളം Speech Recognition")
#         self.root.geometry("500x700")
#         self.root.configure(bg="#1C6074")  # Light blue background
...
#         # Configure styles
#         style.configure("TButton", padding=10, font=('Helvetica', 12), background="#007acc", foreground="#ffffff")
#         style.configure("TLabel", background="#e6f7ff", font=('Helvetica', 12))
...
#         # Title
#         title_label = ttk.Label(main_frame, text="മലയാളം Speech Recognition", font=('Helvetica', 18, 'bold'), background="#e6f7ff")
...
#         # Status
#         self.status_label = ttk.Label(main_frame, text="Status: Idle", foreground="blue", background="#e6f7ff")
#         self.status_label.pack(pady=10)

#         # Real-time Transcription
#         transcription_frame = ttk.LabelFrame(main_frame, text="Real-time Transcription", padding=10)
#         transcription_frame.pack(fill=tk.BOTH, expand=True, pady=10)

#         self.transcription_text = tk.Text(transcription_frame, wrap=tk.WORD, height=8, font=('Helvetica', 11), background="#ffffff")
#         self.transcription_text.pack(fill=tk.BOTH, expand=True)

#         # Response
#         response_frame = ttk.LabelFrame(main_frame, text="Streaming Response", padding=10)
#         response_frame.pack(fill=tk.BOTH, expand=True, pady=10)

#         self.response_text = tk.Text(response_frame, wrap=tk.WORD, height=6, font=('Helvetica', 11), background="#ffffff")
...
#             self.status_label.config(text="Status: Processing audio...", foreground="blue")
...
#             self.status_label.config(text="Status: Stopped, ready to submit", foreground="green")
#     # def stop_recording(self):
#     #     if self.is_recording:
#     #         self.is_recording = False
#     #         self.start_button.config(state=tk.NORMAL)
...
#     #             # Process every n seconds of audio
#     #             if len(buffer) >= self.fs * self.audio_listen_time:
...
#             self.status_label.config(text="Status: No transcription available!", foreground="red")
#             return
...
#     #         self.status_label.config(text="Status: No audio recorded!", foreground="red")
#     #         return
